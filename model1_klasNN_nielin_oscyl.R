...
####--- luty 2023                                                                                      #
#####################################################################################################################
# Napisany kod jest częścią pracy magisterskiej i został napisany na podstawie                                      #
...
# model klasycznej sieci neuronowej do rozwiązania prostego równanie różniczkowego 
# przykład rozwiązanego rr pochodzi z artykułu Hamiltonian NN for solving  equations of motion: 
# dx/dt =p , dp//dt = -(x+x^3).
...
plot(out[,1],out[,2], type = 'l',lwd=3,xlab = 't',ylab = 'x',main = "Kąt wychylenia w czasie")
